...
export function Settings({ onBack, theme, setTheme, accentColor, setAccentColor }: Props) {
  ...
  return (
    <div className="h-screen flex flex-col select-none backdrop-blur-xl bg-[var(--bg-app)]">
      {/* Title bar */}
      <div onMouseDown={() => getCurrentWindow().startDragging()} className="flex items-center gap-2 px-3 py-2 cursor-grab active:cursor-grabbing bg-[var(--bg-surface)]">
        <button
          onClick={onBack}
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-4 pt-4 pb-3">
          <h3 className="text-[11px] font-medium text-[var(--text-tertiary)] uppercase tracking-widest mb-3">外观</h3>
          ...
          {/* Accent color */}
          <div className="mt-4">
            <label className="block text-xs text-[var(--text-secondary)] mb-2">强调色</label>
              ...
              {ACCENT_PRESETS.map((preset) => (
                ...
                >
                  {accentColor === preset.color && (
                    <svg className="w-3.5 h-3.5 text-white absolute inset-0 m-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                    </svg>
                  )}
                </button>
        ...
        {/* History section */}
        <div className="px-4 pt-4 pb-3">
          <h3 className="text-[11px] font-medium text-[var(--text-tertiary)] uppercase tracking-widest mb-3">历史记录</h3>
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-[var(--bg-input)] border border-[var(--border)] rounded-lg px-3 py-2 text-sm text-[var(--text-primary)] focus:border-[var(--border-focus)] focus:bg-[var(--bg-input-focus)] focus:ring-2 focus:ring-[var(--ring-focus)] outline-none transition-all"
                min="100"
                max="10000"
              />
        ...
        <div className="px-4 py-3">
          <h3 className="text-[11px] font-medium text-[var(--text-tertiary)] uppercase tracking-widest mb-3">快捷键</h3>
          <div>
        ...
        {/* System section */}
        <div className="px-4 py-3">
          <h3 className="text-[11px] font-medium text-[var(--text-tertiary)] uppercase tracking-widest mb-3">系统</h3>
